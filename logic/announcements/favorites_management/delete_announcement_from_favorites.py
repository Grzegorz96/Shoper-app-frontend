...
from services.api.announcements import request_to_delete_announcement_from_favorite


def delete_announcement_from_favorites(user_fav_announcement_object, init_favorite_page_frame):
    response_for_deleting_announcement_from_favorite = request_to_delete_announcement_from_favorite(
        user_fav_announcement_object.favorite_announcement_id)
